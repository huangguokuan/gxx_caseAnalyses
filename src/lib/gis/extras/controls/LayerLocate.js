...
define([
    ...
    return declare(null, {
        ...
        locate: function(geometry, isCenter, isEffect, zoom, style, fn, endStatic) {
            var center = null;
            if(geometry) { // && geometry.spatialReference.isWebMercator()
                geometry = WebMercatorUtils.geographicToWebMercator(geometry); //转为墨卡托投影
                ...
                setTimeout(function() {
                    ...
                    else if(isCenter || !(me.map.extent.intersects(center) || me.map.extent.contains(center))) {
        ...
        locateByPolygon: function(geometry, isCenter, isEffect, zoom) {
