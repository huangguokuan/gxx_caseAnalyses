define([
    ...
    return declare(null, {
         ...
         */
        showScalebar: function(isShow) {
            var scalebar = this.gisObj.addScalebar();
            isShow ? scalebar.show() : scalebar.hide();
        },
        /**
         * 显示/隐藏 鹰眼
         * @param {Object} showOrHide
         */
        showOmap: function(isShow) {
            //showOrHide ? this.gisObj._omap.showOmap() : this.gisObj._omap.hideOmap();
            var overViewMap = this.gisObj.addOverViewerMap();
            isShow ? overViewMap.show() : overViewMap.hide();
        },
        /**
         * 显示/隐藏 工具栏
         * @param {Object} showOrHide
        ...
        showInfowindow: function(param) {
            ...
            var lonlat = new Point(parseFloat(param.x), parseFloat(param.y));
            var geom = webMercatorUtils.geographicToWebMercator(lonlat);
            if(geom) {
        ...
        createImg: function(src) {
            ...
            node.src = baseUrl + "/themes/default/img/" + src;
